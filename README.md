...
[We recommend](https://neilmitchell.blogspot.com/2020/09/dont-use-ghcide-anymore-directly.html) installing and using the Haskell extension (`haskell.haskell`) in VS Code, or the prebuilt binaries provided by https://github.com/haskell/haskell-language-server.
